 ...
 * <https://discre.to>
 */};const x="first",P="cookie",j="more",C="remote",q="almost",T="prefs",_=[P,C],z={first:"discreto|prefs|cognito",cookie:"prefs|ok",remote:"discreto|prefs|keep",more:"deny|prefs|allow",almost:"deny|prefs|allow",prefs:"anonymous|ghost|save"},E={ghost:()=>U(!1),anonymous:()=>U(null),discreto:()=>U(null)&&J(),cognito:()=>U(!0)&&J(),allow:()=>B(!0)&&J(),deny:()=>B(!1)&&J(),save:()=>J(),keep:()=>J(),prefs:()=>Y(),cancel:()=>Y(!1),show:()=>N(),ok:()=>N(!1)};let S,M,I=window,D=document,L={dnt:!1,lang:null,mode:null,popup:!1,show:!1,prefs:{},tags:{},level:1,proms:[],ban:!1};function G(){if(!I.discretoConf)return Promise.resolve(!1);if("string"==typeof I.discretoConf){let e=I.discretoConf.match(/^gtm:\/\/([^\/]+)\/(.+)$/);return e?(we("config: gtm"),$(e[1],e[2])):(we("config: json"),h(I.discretoConf).then(e=>{if(200!==e.status)return Promise.reject(e.status);let t=JSON.parse(e.responseText);return t?O(t):Promise.reject(400)}))}return O(I.discretoConf)}function O(e){return u(y,e),u(b,I.discretoLocale||{}),L.lang=m(b,y.gui.lang),M=b[L.lang],we("lang:",L.lang),L.dnt="1"===I.navigator.doNotTrack,y.cookie.dnt&&(L.dnt=!0),I.addEventListener("message",F),we("start"),ae().then(ce).then(()=>ve().then(()=>ie(P,j),()=>oe().then(()=>ie(C,q),()=>Promise.resolve(x))).then(te).then(ye)).catch(e=>{console.error("[discreto] loading failed, check config & locale"),we(e)})}function V(){S.box.parentNode.removeChild(S.box),delete S.box,L.mode=null,L.popup=!1,L.show=!1,L.prefs={},L.tags={},L.level=1,L.proms=[]}function R(e){return new Promise((t,o)=>{if("*"===e.charAt(e.length-1)){let s,n=new RegExp("^"+e+"($|-)"),r=Object.keys(y.services).filter(e=>e.match(n)),i=r.filter(e=>L.prefs[e]);return r.length?i.length?t(i):_.includes(L.mode)?o(null):(s=r.map(e=>R(e).catch(()=>Promise.resolve(null))),Promise.all(s).then(e=>e.filter(e=>L.prefs[e])).then(e=>e.length?t(e):o(null))):o(null)}return L.prefs[e]?t(e):_.includes(L.mode)?o(null):L.proms.push({name:e,resolve:t,reject:o})})}function N(e=!0){return L.popup!==e&&(e||Y(!1),L.popup=e,g(S.box,"min",!e),!0)}function Y(e=!0){return e?(N(),pe(T)):pe(L.mode),e&&(L.mode===x?U(!!y.gui.urge||null):L.mode!==P&&B(!!y.gui.urge||null)),L.show!==e&&(L.show=e,g(S.box,"show",e)),!0}function $(e,t){return ke("gtm",{id:e,args:[t]}),Promise.resolve()}function F(e){let t=e.data,o=t.discreto;o&&(!0!==o?(t.force?L.prefs[o]=t.on:fe(o,t.on),t.force||t.once?ye(!0):J(!0)):Y())}function H(){return we("refresh"),l(L.prefs,fe),!0}function U(e,t=!1){return we(t?"more:":"select:",e),l(y.services,(o,s)=>{t&&void 0!==L.prefs[o]||"_share"!==o&&fe(o,null===e?!!s.anon:e)}),!0}function B(e){return U(e,!0)}function K(e){return fe(e.target.name,e.target.checked)}function W(e){let t=e.target.parentNode,o=e.target.getAttribute("data-name"),s="_discreto"===o?y.cookie:y.services[o];if(s){if(s.info)return we("toggle:",o),void g(s.info,"rolled");s.info=d({tag:"div.info.rolled"}),t.parentNode.insertBefore(s.info,t.nextSibling),we("info:",o),X(o,s).then(e=>{e=e.replace(/{([^}]+)}/g,(e,t)=>y.cookie[t]||t),s.info.innerHTML="<div>"+e+"</div>",setTimeout(()=>g(s.info,"rolled",!1),20)})}else we("unknown:",o)}function X(e,t){let o,s=y.cookie.url,n=t.about;return"_wild"===e?(o=y.cookie.wild.map(e=>"<li>"+e+"</li>"),Promise.resolve("<ul>"+o.join("")+"</ul>")):M.about&&M.about[e]?Promise.resolve(M.about[e]):n?(n instanceof Object&&(n=n[L.lang]||n[y.gui.lang]||M.unknown),Promise.resolve(n)):(we("feed:",e),h(s+"/"+L.lang+"/"+e).then(e=>e.responseText).catch(()=>Promise.resolve(M.msg.error)))}function J(e=!1){return we("save"),l(L.prefs,(e,t)=>{let o=y.services[e];t&&o&&l(o.excl||[],e=>{L.prefs[e]=!1})}),te(P),ye(!0),be(),e||se(),N(!1),!0}function Q(){let e=L.proms;we("resolve"),L.proms=[],l(c("[data-discreto]"),Z),l(e,e=>{let t=e.name;void 0===L.prefs[t]?L.proms.push(e):L.prefs[t]?e.resolve(t):e.reject(null)}),l(L.prefs,(e,t)=>{let o=new I.CustomEvent("discreto-"+e,{detail:t}),s=new I.CustomEvent("discreto",{detail:{name:e,on:t}});D.dispatchEvent(o),D.dispatchEvent(s)})}function Z(e){let t,o=e.tagName.toLowerCase(),s=e.getAttribute("data-src"),n=e.getAttribute("data-class"),r=e.getAttribute("data-discreto");if("*"===r.charAt(r.length-1)){let e=new RegExp("^"+r+"($|-)");t=!!Object.keys(L.prefs).filter(t=>t.match(e)).filter(e=>L.prefs[e]).length,r=r.substr(0,r.length-1)}else t=L.prefs[r];if(t)return we("enabled:",s||o),void(s?(e.removeAttribute("data-discreto"),e.src=s):g(e,n,!0));we("disabled:",s||o),s||g(e,n,!1),"iframe"===o&&ee(e,r,s)}function ee(e,t,o){let s,n,r=y.services[t],i=M.services[t]||t,a="javascript:window.parent.postMessage";r&&r.name&&(i=r.name,i instanceof Object&&(i=i[L.lang]||i[y.gui.lang]||t)),r?s=_.includes(L.mode)?"block":"choose":(we("no pref:",t),s="undef"),n='<!doctype html><html><head><style>html,body{height:100%;margin:0;padding:0}body{display:flex;background-image:linear-gradient(135deg,whitesmoke 25%,white 25%,white 50%,whitesmoke 50%,whitesmoke 75%,white 75%,white 100%,whitesmoke 100%);background-size:60px 60px;justify-content:center;align-items:center;color:black;text-align:center;font:300 14px/1.4 "Helvetica Neue",Helvetica,Arial,sans-serif}big{font-size:3em}a{text-decoration:none;font-weight:600;color:inherit}</style></head><body><div>',n+=M.msg[s].replace("{title}",i).replace("{src}",o),n+=r?'<a href="'+a+"({ discreto: '"+t+"', on: true, once: true }, '*')\">"+M.btns.once+'</a> | <a href="'+a+"({ discreto: '"+t+"', on: true }, '*')\">"+M.btns.always+"</a> | ":'<a href="'+a+"({ discreto: '"+t+"', on: true, force: true }, '*')\">"+M.btns.force+"</a> | ",n+='<a href="'+a+"({ discreto: true }, '*')\">"+M.btns.prefs+"</a>",n+="</div></body></html>",e.setAttribute("src","data:text/html;charset=UTF-8,"+n)}function te(e){we("mode:",e),L.mode=e,pe(e),de(e),H(),e===x&&U(!L.dnt&&null),e===q&&B(!L.dnt&&null),_.includes(e)||N()}function oe(){return y.cookie.share?(g(S.box,"spring",!0),h(y.cookie.url).then(e=>(we("fetch:",e.status),200!==e.status?(403===e.status&&ge(e.responseText),Promise.reject()):(ne(e.responseText),!0))).finally(()=>g(S.box,"spring",!1))):Promise.reject()}function se(){let e="mask="+re()+"&days="+y.cookie.days;return y.cookie.share&&L.prefs._share?h(y.cookie.url,"post",e).then(e=>(we("post:",e.status),201===e.status||(403===e.status&&ge(e.responseText),Promise.reject(e)))).catch(e=>{console.error("[discreto] could not post shared preferences"),we(e)}):Promise.resolve(!1)}function ne(e){""!==e&&l(e.split("|"),e=>{let t="-"!==e.charAt(0);t||(e=e.substr(1)),y.services[e]&&(L.prefs[e]=t)})}function re(){let e=[];return l(L.prefs,(t,o)=>{e.push((o?"":"-")+t)}),e.join("|")}function ie(e,t){let o,s=Object.keys(L.prefs);return o=Object.keys(y.services).filter(e=>"_share"!==e&&!s.includes(e)),o.length?(l(o,e=>{l(S.items[e],e=>{g(e.box,"new",!0)})}),Promise.resolve(t)):Promise.resolve(e)}function ae(){let e,t=y.gui.css;return null===t?Promise.resolve():(!1===t&&l(c("script"),e=>{e.src&&e.src.match(/\/discreto(\.min)?\.js(\?|$)/)&&(t=e.src.replace(/\.js(\?|$)/,".css$1"))}),new Promise((o,s)=>{e=d({tag:"link",atts:{rel:"stylesheet",href:t}}),e.addEventListener("load",o,!0),e.addEventListener("error",s,!0),a("head").appendChild(e)}))}function ce(){return S={},d({tag:"box:aside#discreto.min",evts:{click:E.show},child:[{tag:"div.overlay"},{tag:"div.popup",child:[{tag:"form:form.consent",child:[{tag:"logo:div.logo"},{tag:"head:div.head"},{tag:"prefs:div.prefs",child:[{tag:"div.item",child:[{tag:"label",child:[{tag:"input",atts:{type:"checkbox",checked:"checked",disabled:"disabled"}},{tag:"span",html:M.options.cookie}]},{tag:"i",atts:{"data-name":"_discreto"},evts:{click:W},html:M.btns.cookie}]},{tag:"foot:p.credits",html:M.msg.thanks}]},{tag:"btns:nav.btns",child:[{tag:"front:div.front"},{tag:"back:div.back"}]}]}]}]},S),L.dnt&&g(S.box,"dnt",!0),y.gui.block&&g(S.box,"block",!0),y.gui.pos&&g(S.box,y.gui.pos,!0),y.gui.logo&&S.logo.appendChild(d({tag:"img",atts:{src:y.gui.logo}})),de(T),y.cookie.wild&&(y.services._wild={name:M.options.domains,btn:M.btns.domains,types:["advanced"],anon:!0}),y.cookie.share&&(y.services._share={name:M.options.share,btn:M.btns.share,types:["advanced"]}),S.items={},l(y.services,ue),k.box=S.box,D.body.appendChild(S.box),Promise.resolve()}function le(e){d({tag:e+":fieldset.field."+e,child:[{tag:"legend",html:M.types[e]}]},S),S.prefs.insertBefore(S[e],S.foot)}function ue(e,t){S.items[e]||(S.items[e]=[]),l(t.types,(o,s)=>{S[o]||le(o);let n={},r=t.name||M.services[e]||e;r instanceof Object&&(r=r[L.lang]||r[y.gui.lang]||e),d({tag:"box:div.item",child:[{tag:"label",child:[{tag:"check:input",evts:{change:K},atts:{type:"checkbox",name:e}},{tag:"span",html:r}]},{tag:"i",evts:{click:W},atts:{class:s?"none":"","data-name":e},html:t.btn||M.btns.about}]},n),S.items[e].push(n),S[o].appendChild(n.box)})}function de(e){let t=z[e].split("|"),o=S[e===T?"back":"front"];for(;o.firstChild;)o.firstChild.remove();l(t,e=>{o.appendChild(d({tag:"button",atts:{type:"button"},evts:{click:E[e]},html:M.btns[e]}))})}function pe(e){let t=M.msg[e],o=!0,s=!0,n=he();e===x&&L.dnt&&(t=M.msg.dnt),e===P&&(l(L.prefs,(e,t)=>{let n=y.services[e];n&&(s&=!t,"_wild"!==e&&"_share"!==e&&(o&=!t||n.anon))}),s?t=M.msg.ghost:o&&(t=M.msg.anon)),t=t.replace(/{([^}]+)}/g,(e,t)=>n[t]),S.head.innerHTML=t}function ge(e){let t=d({tag:"div.info.misuse",html:e});S.advanced.appendChild(t),S.items._share[0].check.disabled=!0,fe("_share",!1),L.ban=!0}function me(){let e=he(),t=Math.ceil(5*e.active/e.total);t!==L.level&&(g(S.box,"cognito"+t,!0),g(S.box,"cognito"+L.level,!1),L.level=t)}function he(){let e,t=Object.keys(L.prefs),o=Object.keys(y.services),s=t.filter(e=>L.prefs[e]);return e=o.filter(e=>"_share"!==e&&!t.includes(e)),{total:o.length,active:s.length,more:e.length}}function fe(e,t){let o=y.services[e];return o?!!S.items[e]&&(("_share"!==e||!L.ban)&&(L.prefs[e]=t,l(S.items[e],e=>{e.check.checked=t}),l(o.excl||[],e=>{l(S.items[e],o=>{o.check.disabled=t,o.check.checked=!t&&L.prefs[e]})}),me(),!0)):(we("unknown:",e),!1)}function ve(){let e=y.cookie.name,t=new RegExp("(?:(?:^|.*;\\s*)"+e+"\\s*=\\s*([^;]*).*$)|^.*$"),o=D.cookie.match(t);return void 0===o[1]?Promise.reject():(ne(o[1]),Promise.resolve())}function be(){let e=y.cookie.name,t=e+"="+re(),o=new Date,s=e+"=",n=new Date,r=y.cookie.path||"/",i=D.location.hostname,a=i.replace(/^(?:.+\.)?([^\.]+\.[^\.]+)$/,"$1");return i="."+i,n.setDate(n.getDate()-1),s+=";path="+r,s+=";expires="+n.toUTCString(),D.cookie=s+";domain="+i,y.cookie.wild&&(D.cookie=s+";domain="+a),o.setDate(o.getDate()+y.cookie.days),t+=";path="+r,t+=";expires="+o.toUTCString(),t+=";domain="+(L.prefs._wild?a:i),D.cookie=t,we("write:",t),Promise.resolve()}function ye(e=!1){let t={};return l(L.prefs,(o,s)=>{let n,r=y.services[o];s&&r&&r.tag&&(t[r.tag]||(t[r.tag]={args:[],cmds:[],anon:!1}),n=t[r.tag],n.anon|=r.anon,r.cmd&&n.cmds.push(r.cmd),e&&r.save?l(r.save.split(","),e=>n.args.push(e.trim())):r.load&&l(r.load.split(","),e=>n.args.push(e.trim())))}),l(t,ke),Q(),Promise.resolve(!0)}function ke(e,t){let o,s,n=k[e],r=t.id||y.ids[e];if(n){if(!n.on){if(we("append:",e),n.init){try{o=n.init(r,t.anon)}catch(t){we("init failed:",e,t),o=null}o&&("string"==typeof o&&(o={src:o}),s=p(o.src),l(o,(e,t)=>{"src"!==e&&s.setAttribute(e,t)}))}n.on=!0,n.sent=[]}if(l(t.cmds,e=>e(r)),t.args=t.args.filter(e=>!n.sent.includes(e)),t.args.length)try{n.start&&n.start(t.args),n.sent.push.apply(n.sent,t.args)}catch(t){we("start failed:",e,t)}}else we("missing:",e)}function we(...e){y.debug&&(e.unshift("[discreto]"),i.apply(s,e))}I.discreto={start:O,clean:V,when:R,prefs:Y,popup:N,mode:te,conf:y,state:L},I.addEventListener("load",G,!0)}]);