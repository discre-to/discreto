 ...
 * <https://discre.to>
 */};const x="first",P="cookie",j="more",C="remote",q="almost",T="prefs",_=[P,C],S={first:"discreto|prefs|cognito",cookie:"prefs|ok",remote:"discreto|prefs|keep",more:"deny|prefs|allow",almost:"deny|prefs|allow",prefs:"anonymous|ghost|save"},z={ghost:()=>B(!1),anonymous:()=>B(null),discreto:()=>B(null)&&Q(),cognito:()=>B(!0)&&Q(),allow:()=>K(!0)&&Q(),deny:()=>K(!1)&&Q(),save:()=>Q(),keep:()=>Q(),prefs:()=>Y(),cancel:()=>Y(!1),show:()=>$(),ok:()=>$(!1)};let E,M,I=window,L=document,D={dnt:!1,lang:null,mode:null,popup:!1,show:!1,prefs:{},tags:{},level:1,proms:[],ban:!1};function G(){if(!I.discretoConf)return Promise.resolve(!1);if("string"==typeof I.discretoConf){let e=I.discretoConf.match(/^gtm:\/\/([^\/]+)\/(.+)$/);return e?(Ae("config: gtm"),F(e[1],e[2])):(Ae("config: json"),h(I.discretoConf).then(e=>{if(200!==e.status)return Promise.reject(e.status);let t=JSON.parse(e.responseText);return t?O(t):Promise.reject(400)}))}return O(I.discretoConf)}function O(e){return u(y,e),u(b,I.discretoLocale||{}),D.lang=m(b,y.gui.lang),M=b[D.lang],Ae("lang:",D.lang),D.dnt="1"===I.navigator.doNotTrack,y.cookie.dnt&&(D.dnt=!0),I.addEventListener("message",H),Ae("start"),ce().then(le).then(()=>be().then(()=>ae(P,j),()=>se().then(()=>ae(C,q),()=>Promise.resolve(x))).then(oe).then(ke)).catch(e=>{console.error("[discreto] loading failed, check config & locale"),Ae(e)})}function V(){E.box.parentNode.removeChild(E.box),delete E.box,D.mode=null,D.popup=!1,D.show=!1,D.prefs={},D.tags={},D.level=1,D.proms=[]}function R(e){return new Promise((t,o)=>{if("*"===e.charAt(e.length-1)){let s,n=new RegExp("^"+e+"($|-)"),r=Object.keys(y.services).filter(e=>e.match(n)),i=r.filter(e=>D.prefs[e]);return r.length?i.length?t(i):_.includes(D.mode)?o(null):(s=r.map(e=>R(e).catch(()=>Promise.resolve(null))),Promise.all(s).then(e=>e.filter(e=>D.prefs[e])).then(e=>e.length?t(e):o(null))):o(null)}return D.prefs[e]?t(e):_.includes(D.mode)?o(null):D.proms.push({name:e,resolve:t,reject:o})})}function N(e,t,o=!1){e&&(ve(e,t),o?Q(!0):ke(!0))}function $(e=!0){return D.popup!==e&&(e||Y(!1),D.popup=e,g(E.box,"min",!e),!0)}function Y(e=!0){return e?($(),ge(T)):ge(D.mode),e&&(D.mode===x?B(!!y.gui.urge||null):D.mode!==P&&K(!!y.gui.urge||null)),D.show!==e&&(D.show=e,g(E.box,"show",e)),!0}function F(e,t){return we("gtm",{id:e,args:[t]}),Promise.resolve()}function H(e){let t=e.data,o=t.discreto;o&&(!0!==o?(t.force?D.prefs[o]=t.on:ve(o,t.on),t.force||t.once?ke(!0):Q(!0)):Y())}function U(){return Ae("refresh"),l(D.prefs,ve),!0}function B(e,t=!1){return Ae(t?"more:":"select:",e),l(y.services,(o,s)=>{t&&void 0!==D.prefs[o]||"_share"!==o&&(s.force||ve(o,null===e?!!s.anon:e))}),!0}function K(e){return B(e,!0)}function W(e){return ve(e.target.name,e.target.checked)}function X(e){let t=e.target.parentNode,o=e.target.getAttribute("data-name"),s="_discreto"===o?y.cookie:y.services[o];if(s){if(s.info)return Ae("toggle:",o),void g(s.info,"rolled");s.info=d({tag:"div.info.rolled"}),t.parentNode.insertBefore(s.info,t.nextSibling),Ae("info:",o),J(o,s).then(e=>{e=e.replace(/{([^}]+)}/g,(e,t)=>y.cookie[t]||t),s.info.innerHTML="<div>"+e+"</div>",setTimeout(()=>g(s.info,"rolled",!1),20)})}else Ae("unknown:",o)}function J(e,t){let o,s=y.cookie.url,n=t.about;return"_wild"===e?(o=y.cookie.wild.map(e=>"<li>"+e+"</li>"),Promise.resolve("<ul>"+o.join("")+"</ul>")):M.about&&M.about[e]?Promise.resolve(M.about[e]):n?(n instanceof Object&&(n=n[D.lang]||n[y.gui.lang]||M.unknown),Promise.resolve(n)):(Ae("feed:",e),h(s+"/"+D.lang+"/"+e).then(e=>e.responseText).catch(()=>Promise.resolve(M.msg.error)))}function Q(e=!1){return Ae("save"),l(D.prefs,(e,t)=>{let o=y.services[e];t&&o&&l(o.excl||[],e=>{D.prefs[e]=!1})}),oe(P),ke(!0),ye(),e||ne(),$(!1),!0}function Z(){let e=D.proms;Ae("resolve"),D.proms=[],l(c("[data-discreto]"),ee),l(e,e=>{let t=e.name;void 0===D.prefs[t]?D.proms.push(e):D.prefs[t]?e.resolve(t):e.reject(null)}),l(D.prefs,(e,t)=>{let o=new I.CustomEvent("discreto-"+e,{detail:t}),s=new I.CustomEvent("discreto",{detail:{name:e,on:t}});L.dispatchEvent(o),L.dispatchEvent(s)})}function ee(e){let t,o=e.tagName.toLowerCase(),s=e.getAttribute("data-src"),n=e.getAttribute("data-class"),r=e.getAttribute("data-discreto");if("*"===r.charAt(r.length-1)){let e=new RegExp("^"+r+"($|-)");t=!!Object.keys(D.prefs).filter(t=>t.match(e)).filter(e=>D.prefs[e]).length,r=r.substr(0,r.length-1)}else t=D.prefs[r];if(t)return Ae("enabled:",s||o),void(s?(e.removeAttribute("data-discreto"),e.src=s):g(e,n,!0));Ae("disabled:",s||o),s||g(e,n,!1),"iframe"===o&&te(e,r,s)}function te(e,t,o){let s,n,r,i=y.services[t],a=M.services[t]||t,c="javascript:window.parent.postMessage";i&&i.name&&(a=i.name,a instanceof Object&&(a=a[D.lang]||a[y.gui.lang]||t)),i?s=_.includes(D.mode)?"block":"choose":(Ae("no pref:",t),s="undef"),r='<!doctype html><html><head><style>html,body{height:100%;margin:0;padding:0}body{display:flex;background-image:linear-gradient(135deg,whitesmoke 25%,white 25%,white 50%,whitesmoke 50%,whitesmoke 75%,white 75%,white 100%,whitesmoke 100%);background-size:60px 60px;justify-content:center;align-items:center;color:black;text-align:center;font:300 14px/1.4 "Helvetica Neue",Helvetica,Arial,sans-serif}big{font-size:3em}a{text-decoration:none;font-weight:600;color:inherit}</style></head><body><div>',n=o.replace(/\?.+$/,""),r+=M.msg[s].replace("{title}",a).replace("{src}",n),r+=i?'<a href="'+c+"({ discreto: '"+t+"', on: true, once: true }, '*')\">"+M.btns.once+'</a> | <a href="'+c+"({ discreto: '"+t+"', on: true }, '*')\">"+M.btns.always+"</a> | ":'<a href="'+c+"({ discreto: '"+t+"', on: true, force: true }, '*')\">"+M.btns.force+"</a> | ",r+='<a href="'+c+"({ discreto: true }, '*')\">"+M.btns.prefs+"</a>",r+="</div></body></html>",e.setAttribute("src","data:text/html;charset=UTF-8,"+r)}function oe(e){Ae("mode:",e),D.mode=e,ge(e),pe(e),U(),e===x&&B(!D.dnt&&null),e===q&&K(!D.dnt&&null),_.includes(e)||$()}function se(){return!y.cookie.share||D.dnt?Promise.reject():(g(E.box,"spring",!0),h(y.cookie.url).then(e=>(Ae("fetch:",e.status),200!==e.status?(403===e.status&&me(e.responseText),Promise.reject()):(re(e.responseText),!0))).finally(()=>g(E.box,"spring",!1)))}function ne(){let e="mask="+ie()+"&days="+y.cookie.days;return y.cookie.share&&D.prefs._share?h(y.cookie.url,"post",e).then(e=>(Ae("post:",e.status),201===e.status||(403===e.status&&me(e.responseText),Promise.reject(e)))).catch(e=>{console.error("[discreto] could not post shared preferences"),Ae(e)}):Promise.resolve(!1)}function re(e){""!==e&&l(e.split("|"),e=>{let t="-"!==e.charAt(0);t||(e=e.substr(1)),y.services[e]&&(D.prefs[e]=t)})}function ie(){let e=[];return l(D.prefs,(t,o)=>{e.push((o?"":"-")+t)}),e.join("|")}function ae(e,t){let o,s=Object.keys(D.prefs);return o=Object.keys(y.services).filter(e=>"_share"!==e&&!s.includes(e)),o.length?(l(o,e=>{l(E.items[e],e=>{g(e.box,"new",!0)})}),Promise.resolve(t)):Promise.resolve(e)}function ce(){let e,t=y.gui.css;return null===t?Promise.resolve():(!1===t&&l(c("script"),e=>{e.src&&e.src.match(/\/discreto(\.min)?\.js(\?|$)/)&&(t=e.src.replace(/\.js(\?|$)/,".css$1"))}),new Promise((o,s)=>{e=d({tag:"link",atts:{rel:"stylesheet",href:t}}),e.addEventListener("load",o,!0),e.addEventListener("error",s,!0),a("head").appendChild(e)}))}function le(){return E={},d({tag:"box:aside#discreto.min",evts:{click:z.show},child:[{tag:"div.overlay"},{tag:"div.popup",child:[{tag:"form:form.consent",child:[{tag:"div.main",child:[{tag:"logo:div.logo"},{tag:"head:div.head"},{tag:"prefs:div.prefs",child:[{tag:"mandatory:fieldset.field",child:[{tag:"div.item",child:[{tag:"label",child:[{tag:"input",atts:{type:"checkbox",checked:"checked",disabled:"disabled"}},{tag:"span",html:M.options.cookie}]},{tag:"i",atts:{"data-name":"_discreto"},evts:{click:X},html:M.btns.cookie}]}]},{tag:"foot:p.credits",html:M.msg.thanks}]}]},{tag:"btns:nav.btns",child:[{tag:"front:div.front"},{tag:"back:div.back"}]}]}]}]},E),D.dnt&&g(E.box,"dnt",!0),y.gui.block&&g(E.box,"block",!0),y.gui.hide&&g(E.box,"hide",!0),y.gui.pos&&g(E.box,y.gui.pos,!0),y.gui.logo&&E.logo.appendChild(d({tag:"img",atts:{src:y.gui.logo}})),pe(T),y.cookie.wild&&(y.services._wild={name:M.options.domains,btn:M.btns.domains,types:["advanced"],anon:!0}),y.cookie.share&&(y.services._share={name:M.options.share,btn:M.btns.share,types:["advanced"]}),E.items={},l(y.services,de),k.box=E.box,L.body.appendChild(E.box),Promise.resolve()}function ue(e){d({tag:e+":fieldset.field."+e,child:[{tag:"legend",html:M.types[e]}]},E),E.prefs.insertBefore(E[e],E.foot)}function de(e,t){E.items[e]||(E.items[e]=[]),l(t.types,(o,s)=>{E[o]||ue(o);let n={},r={type:"checkbox",name:e},i=t.name||M.services[e]||e;i instanceof Object&&(i=i[D.lang]||i[y.gui.lang]||e),t.force&&(D.prefs[e]=!0,r.checked=!0,r.disabled=!0),d({tag:"box:div.item",child:[{tag:"label",child:[{tag:"check:input",evts:{change:W},atts:r},{tag:"span",html:i}]},{tag:"i",evts:{click:X},atts:{class:s?"none":"","data-name":e},html:t.btn||M.btns.about}]},n),E.items[e].push(n),E[o].appendChild(n.box)})}function pe(e){let t=S[e].split("|"),o=E[e===T?"back":"front"],s=e===x&&!D.dnt;for(;o.firstChild;)o.firstChild.remove();l(t,e=>{let t="discreto"===e&&s?"continue":e;o.appendChild(d({tag:"button",atts:{type:"button"},evts:{click:z[e]},html:M.btns[t]}))})}function ge(e){let t=M.msg[e],o=!0,s=!0,n=fe();e===x&&D.dnt&&(t=M.msg.dnt),e===P&&(l(D.prefs,(e,t)=>{let n=y.services[e];n&&(s&=!t,"_wild"!==e&&"_share"!==e&&(o&=!t||n.anon))}),s?t=M.msg.ghost:o&&(t=M.msg.anon)),t=t.replace(/{([^}]+)}/g,(e,t)=>n[t]),E.head.innerHTML=t}function me(e){let t=d({tag:"div.info.misuse",html:e});E.advanced.appendChild(t),E.items._share[0].check.disabled=!0,ve("_share",!1),D.ban=!0}function he(){let e=fe(),t=Math.ceil(5*e.active/e.total);t!==D.level&&(g(E.box,"cognito"+t,!0),g(E.box,"cognito"+D.level,!1),D.level=t)}function fe(){let e,t=Object.keys(D.prefs),o=Object.keys(y.services),s=t.filter(e=>D.prefs[e]);return e=o.filter(e=>"_share"!==e&&!t.includes(e)),{total:o.length,active:s.length,more:e.length}}function ve(e,t){let o=y.services[e];return o?!!E.items[e]&&(("_share"!==e||!D.ban)&&(D.prefs[e]=t,l(E.items[e],e=>{e.check.checked=t}),l(o.excl||[],e=>{l(E.items[e],o=>{o.check.disabled=t,o.check.checked=!t&&D.prefs[e]})}),he(),!0)):(Ae("unknown:",e),!1)}function be(){let e=y.cookie.name,t=new RegExp("(?:(?:^|.*;\\s*)"+e+"\\s*=\\s*([^;]*).*$)|^.*$"),o=L.cookie.match(t);return void 0===o[1]?Promise.reject():(re(o[1]),Promise.resolve())}function ye(){let e=y.cookie.name,t=e+"="+ie(),o=new Date,s=e+"=",n=new Date,r=y.cookie.path||"/",i=L.location.hostname,a=i.replace(/^(?:.+\.)?([^\.]+\.[^\.]+)$/,"$1");return i="."+i,n.setDate(n.getDate()-1),s+=";path="+r,s+=";expires="+n.toUTCString(),L.cookie=s+";sameSite=Strict;domain="+i,y.cookie.wild&&(L.cookie=s+";sameSite=Lax;domain="+a),o.setDate(o.getDate()+parseInt(y.cookie.days)),t+=";path="+r,t+=";expires="+o.toUTCString(),t+=";sameSite="+(D.prefs._wild?"Lax":"Strict"),t+=";domain="+(D.prefs._wild?a:i),L.cookie=t,Ae("write:",t),Promise.resolve()}function ke(e=!1){let t={};return l(D.prefs,(o,s)=>{let n,r=y.services[o];s&&r&&r.tag&&(t[r.tag]||(t[r.tag]={args:[],cmds:[],anon:!1}),n=t[r.tag],n.anon|=r.anon,r.cmd&&n.cmds.push(r.cmd),e&&r.save?l(r.save.split(","),e=>n.args.push(e.trim())):r.load&&l(r.load.split(","),e=>n.args.push(e.trim())))}),l(t,we),Z(),Promise.resolve(!0)}function we(e,t){let o,s,n=k[e],r=t.id||y.ids[e];if(n){if(!n.on){if(Ae("append:",e),n.init){try{o=n.init(r,t.anon)}catch(t){Ae("init failed:",e,t),o=null}o&&("string"==typeof o&&(o={src:o}),s=p(o.src),l(o,(e,t)=>{"src"!==e&&s.setAttribute(e,t)}))}n.on=!0,n.sent=[]}if(l(t.cmds,e=>e(r)),t.args=t.args.filter(e=>!n.sent.includes(e)),t.args.length)try{n.start&&n.start(t.args),n.sent.push.apply(n.sent,t.args)}catch(t){Ae("start failed:",e,t)}}else Ae("missing:",e)}function Ae(...e){y.debug&&(e.unshift("[discreto]"),i.apply(s,e))}I.discreto={start:O,clean:V,when:R,update:N,prefs:Y,popup:$,mode:oe,conf:y,state:D},I.addEventListener("load",G,!0)}]);